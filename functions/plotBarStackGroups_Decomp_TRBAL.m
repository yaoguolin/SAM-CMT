function [] = plotBarStackGroups_Decomp_Extreme(stackData,stackData_tot, groupLabels,eleLabels,ylabel1,unit,tlt,result_dir,filename)
...
set(objH(NumElement+2), 'Pos', [0.1 pos1(2:3)-0.035], 'String', ['S1:   25% tariff increase' newline '        Trade Balance']); 
set(objH(NumElement+3), 'Pos', [0.1 pos2(2:3)], 'String', ['']); 
set(objH(NumElement+4), 'Pos', [0.1 pos3(2:3)-0.09], 'String', ['S2:   25% tariff increase' newline '        Economic Damage' newline ...
    '         Cost' newline '        ']); 
