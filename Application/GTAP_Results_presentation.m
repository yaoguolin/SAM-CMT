...
tlt = 'Harvested area';
y_label = 'Harvested area changes (ha)';
h1 = RESULTS_decomp_graph05232019(portf.HARVST_Delta_order.*100,portf.HARVST_DeltaCO_order.*100, tlt,y_label,CN_Label,CR_Label);

xlim([0.3,7.7])

axes(ha(2));
tlt = 'Nitrogen surplus';
y_label = 'Nitrogen surplus changes (kg)';
h2 = RESULTS_decomp_graph05232019(Nitr.Nsur.Nsur_kg_Delta_order,Nitr.Nsur.Nsur_kg_DeltaCO_order, tlt,y_label,CN_Label,CR_Label);
xlim([0.3,7.7])

axes(ha(3));
tlt = 'Phosphorus surplus';
y_label = 'Phosphorus surplus changes (kg)';
h3 = RESULTS_decomp_graph05232019(Phos.Psur.Psur_kg_Delta_order,Phos.Psur.Psur_kg_DeltaCO_order, tlt,y_label,CN_Label,CR_Label);
xlim([0.3,7.7])

axes(ha(4));
tlt = 'Blue water use';
y_label = 'Blue water use Changes (L)';
h4 = RESULTS_decomp_graph05232019(Wat.Blue.BlueW_L_Delta_order,Wat.Blue.BlueW_L_DeltaCO_order, tlt,y_label,CN_Label,CR_Label);
xlim([0.3,7.7])

CRLABEL = horzcat(CR_Label, "Total");
...
HARVST_pchange_std = [0.026 0.005 0.199 0.004 0.031 0.006];
...
tlt = 'Harvested Area';
y_label = 'Harvested Area Changes (ha)';
h1 = RESULTS_decomp_graph07202020_errorbar(portf.HARVST_Delta_order.*100,portf.HARVST_DeltaCO_order.*100, tlt,y_label,CN_Label,CR_Label);
